...
<!--Icono-->
 ...
 <!--Estilos-->
    <link rel="stylesheet" href="css/stylesan.css">
 ...
 <!--IMG Header-->
   <!--IMG Header-->
    <div class="img-header">
        <div class="welcome">
            <div class="w"><h1>Anillos</h1> </div>
            <hr>
            <p>Dusfont | Tu Moda a tu Estilo</p>
...
<div class="row ">
<?php
$sentencia=$pdo->prepare("SELECT * FROM `tblproductos`  WHERE `subcategoria`=4");
...
<div class="row ">
<?php
$sentencia=$pdo->prepare("SELECT * FROM `tblproductos` WHERE `subcategoria`=5");
