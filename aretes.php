...
<hr class="my-0 bg-danger">
 <!--IMG Header-->
    ...
    <div class="img-header">
        <div class="welcome">
            <div class="w"><h1>Aretes</h1> </div>
            <hr>
            <p>Encuentra la mejor variedad de Aretes artesanales</p>
...
<div class="row ">
<?php
$sentencia=$pdo->prepare("SELECT * FROM `tblproductos`  WHERE `subcategoria`=2");
...
<div class="row ">
<?php
$sentencia=$pdo->prepare("SELECT * FROM `tblproductos` WHERE `subcategoria`=3");
